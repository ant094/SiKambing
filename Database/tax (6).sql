...
--
-- Table structure for table `kpar`
--

CREATE TABLE `kpar` (
  `id_kpar` int(11) NOT NULL,
  `judul` varchar(255) NOT NULL,
  `user` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `kpar`
--

INSERT INTO `kpar` (`id_kpar`, `judul`, `user`) VALUES
(2, 'Penyembahan ', ''),
(3, 'Hati sbagai hamba ', ''),
(4, 'Janjimu sperti fajar', ''),
(5, 'Tetap setia ', ''),
(6, 'Kupandang wajahmu', ''),
(7, 'Pribadi tang mengenal hatiku', ''),
(8, 'Hatiku percaya', ''),
(9, 'Mujizat itu nyata', ''),
(10, 'Allah peduli', ''),
(11, 'Kusiapkan hatiku Tuhan', ''),
(12, 'Bapa yang kekal', ''),
(13, 'Ku tetap cinta Yesus', ''),
(14, 'Betapa hatiku', ''),
(15, 'Seperti yang kau ingini', ''),
(16, 'Selamat pagi bapa', ''),
(17, 'Sejauh timur dari barat', ''),
(18, 'Ku mau sperti mu Yesus', ''),
(19, 'Karya terbesar', ''),
(20, 'Dengan apa kan kubalas', ''),
(21, 'Kaulah harapan ', ''),
(22, 'Bejana ', ''),
(23, 'Amazing grace', ''),
(24, 'Sampai akhir hidupku', ''),
(25, 'Pertolonganmu ', ''),
(26, 'Bapa engkau sungguh baik', ''),
(27, 'Bapa sorgawi ', ''),
(28, 'Ajarku berdiam ', ''),
(29, 'Ku milikmu', ''),
(30, 'Waktu Tuhan', ''),
...
(32, 'Allahku dahsyat', ''),
(33, 'Jangan lelah', ''),
(34, 'Yesus kekasih jiwaku', ''),
(35, 'Kecaplah dan lihatlah ', ''),
(36, 'Allah itu baik, sungguh amat baik', ''),
(37, 'Bersyukurlah ', ''),
(38, 'Dia lahir untuk kami ', ''),
(39, 'Ku dibri kuasa', '');
...
(6, 'melisa', 'melisa@kpar.com', 'melisa123', '1'),
(7, 'vani', 'vani@kpar.com', 'vani222', '1'),
(8, 'aden', 'aden@kpar.com', 'aden269', '1'),
(9, 'endar', 'endar@kpar.com', 'endar111', '1'),
(10, 'lepin', 'lepin@kpar.com', 'lepin311', '1'),
(11, 'ester', 'ester@kpar.com', 'ester112', '1'),
(12, 'josua', 'josua@kpar.com', 'josua225', '1');
...
--
-- Indexes for table `kpar`
--
ALTER TABLE `kpar`
  ADD PRIMARY KEY (`id_kpar`);
...
--
-- AUTO_INCREMENT for table `kpar`
--
ALTER TABLE `kpar`
  MODIFY `id_kpar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
